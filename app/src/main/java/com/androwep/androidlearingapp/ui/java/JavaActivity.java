...
import com.androwep.androidlearingapp.databinding.ActivityJavaBinding;
import com.androwep.androidlearingapp.ui.codedetails.CodeDetailsActivity;
...
private List<CodeModel> codeModels;
    ...
    private void initAdapterItems() {
        ...
        codeModel = new CodeModel(1, "Hello World", "class Simple{  \n" +
